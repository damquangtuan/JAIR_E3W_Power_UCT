...
folder_name_uct = 'logs/expl_%.2f_tau_%.2f' % (exploration_coeff, tau)
...
for kk, dd in zip(k, d):
    ...
    for alpha in alphas:
        for alg in algs:
            ...
            plt.plot(avg_diff_uct, linewidth=4)
            ...
            plt.plot(avg_regret, linewidth=4)
